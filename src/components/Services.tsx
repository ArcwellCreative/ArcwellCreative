  ...
  return (
    <section id="services" className="border-t border-cream/10 py-28 sm:py-36">
      <div className="container-arc">
        ...
        <Reveal delay={0.1}>
          <h2 className="text-h2 mt-6 max-w-2xl font-display font-medium tracking-tight text-cream">
            Everything your business needs to{" "}
            <span className="font-extrabold text-copper-light">look the part.</span>
          </h2>
        </Reveal>
